        ...
        <div className="p-5">
          ...
          <div className="space-y-8">
            {IoTDataHackathon2026Projects.map((proj) => (
              <div key={proj.name} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl p-5 flex flex-col md:flex-row items-center gap-5 hover:scale-105 transition">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold mb-1 text-gray-800 dark:text-gray-200">{proj.name}</h3>
                  <p className="mb-2 text-gray-600 dark:text-gray-300">{proj.description}</p>
